  ...
  export const run = async () => {
      ...
      const input =
      "Who is imran khan?" +
      " What is his current age and how many years he spend in politics so far?";
      ...
      // Loaded agent.
      // Executing with input "Who is imran khan? What is his current age and how many years he spend in politics so far?"...
      // Got output Imran Khan is 70 years old and has been in politics for over 25 years.
  };
